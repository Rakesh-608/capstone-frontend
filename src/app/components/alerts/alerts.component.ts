...
//   alerts: Alert[] = [];
//   expandedAlerts: boolean[] = []; // Array to track expanded state
...
//     // Initialize expandedAlerts to false for each alert
//     this.expandedAlerts = new Array(this.alerts.length).fill(false);
//   }

//   toggleDetails(index: number): void {
//     this.expandedAlerts[index] = !this.expandedAlerts[index]; // Toggle the state
//   }
// }
